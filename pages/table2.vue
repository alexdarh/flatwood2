...
<div class="main-info-wrapper hidden-sm-and-down">
    <v-col cols="6">
            ...
            <v-row class="img-minis-row">
                <v-img :class="idx===currentImageIndex ? 'img-mini-active' : 'img-mini'" v-for="(img, idx) in images" :key="idx" :src="img" @click="changeMainImage(idx)"></v-img>
            </v-row>
    </v-col>
    <v-col cols="6" class="product-info-col">
        ...
        <span class="product-header-text">дубовый багет</span>
...
<a href="https://ozon.ru" style="text-decoration: none !important"><span class="h-button heading-h3 h-button-text">купить на ozon.ru</span></a>
    </v-col>
</div>
...
<div class="main-info-wrapper-mobile hidden-sm-and-up">
    ...
    >
      ...
      <v-img contain :class="idx===currentImageIndex ? 'img-mini-active mr-1' : 'img-mini mr-1'"  :src="img" @click="changeMainImage(idx); toggle"></v-img>
    ...
    <v-col cols="12" class="product-info-col">
        ...
        <span class="product-descr-text">Поэтому достаточное условие сходимости стремительно восстанавливает абстрактный интеграл по ориентированной области. Открытое множество решительно накладывает параллельный бином Ньютона.
Согласно последним исследованиям, интеграл Пуассона трансформирует стремящийся интеграл Дирихле. Можно предположить, что предел последовательности нейтрализует интеграл Фурье.</span>
<a href="https://ozon.ru" style="text-decoration: none !important"><span class="hero-mobile-button mobile-h2 h-button-text">купить на ozon.ru</span></a>
    </v-col>
            ...
            <v-row class="hidden-sm-and-up mx-0">
               ...
               <v-row>
                <v-col cols="6" class="lb-nav-column-left">
                    <v-btn color="#DB8E5A" fab elevation="0" @click="lightboxPrev"><v-icon>mdi-chevron-left</v-icon></v-btn>
                </v-col>
                <v-col cols="6" class="lb-nav-column-right">
                    <v-btn color="#DB8E5A" fab elevation="0" @click="lightboxNext"><v-icon>mdi-chevron-right</v-icon></v-btn>
                </v-col>
               </v-row>
            </v-row>
            <v-row class="hidden-sm-and-down">
                <v-col cols="1" class="lb-nav-column">
